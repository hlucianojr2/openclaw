...
export declare function createPluginRegistry(registryParams: PluginRegistryParams): {
    ...
    registerChannel: (record: PluginRecord, registration: ChannelPlugin | OpenClawPluginChannelRegistration) => void;
    ...
    registerHook: (record: PluginRecord, events: string | string[], handler: import("../hooks/internal-hooks.js").InternalHookHandler, opts: OpenClawPluginHookOptions | undefined, config: import("../config/types.openclaw.js").OpenClawConfig) => void;
