...
export declare const ConnectParamsSchema: import("@sinclair/typebox").TObject<{
    ...
    client: import("@sinclair/typebox").TObject<{
        id: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"cli" | "fingerprint" | "gateway-client" | "node-host" | "openclaw-android" | "openclaw-control-ui" | "openclaw-ios" | "openclaw-macos" | "openclaw-probe" | "test" | "webchat" | "webchat-ui">[]>;
        ...
        mode: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"backend" | "cli" | "node" | "probe" | "test" | "ui" | "webchat">[]>;
